    ...
    <div class="footer-top section-padding">
        <div class="container">
            <div class="row">
                    ...
                    <div class="widget-item">
                        <div class="widget-title">
                            <div class="widget-logo">
                                <a href="index.html">
                                    <img src="assets/img/logo/logo.ico" alt="brand logo">
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="widget-item">
                        <h6 class="widget-title">Thông Tin Cửa Hàng</h6>
                        <div class="widget-body">
                            <address class="contact-block">
                                <ul>
                                    <li><i class="pe-7s-home"></i>Địa chỉ: Hai Bà Trưng-Hà Nội</li>
                                    <li><i class="pe-7s-mail"></i> <a href="mailto:demo@plazathemes.com">Email:
                                            KFCshop@gmail.com</a></li>
                                    <li><i class="pe-7s-call"></i> <a href="tel:(012)800456789987">Số điện thoại:
                                            0123456789</a></li>
                                </ul>
                            </address>
                        </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="widget-item">
                        <h6 class="widget-title">Chính Sách Và Hỗ Trợ Khách Hàng</h6>
                        <div class="widget-body">
                            <ul class="info-list">

        ...
        <div class="container py-2">
            ...
            <div class="row">
                <div class="section-title text-center" style="margin-bottom: 30px;">
                    <h2 class="title" style="font-size: 28px; font-weight: bold; color: #333;">KFC Food</h2>
                </div>
                <?php foreach ($listDanhMuc as $key => $danhMuc): ?>
                    <div class="col-lg-3 col-md-4 col-sm-6 mb-4">
                        <a href="<?= BASE_URL . '?act=san-pham-theo-danh-muc&id_danh_muc=' . $danhMuc['id']; ?>" class="text-decoration-none text-dark">
